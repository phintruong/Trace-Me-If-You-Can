"""FastAPI app: GET /account/{account_id}, /health. Port 8080."""
...
app = FastAPI(title="Fraud Alerts API", version="1.0", lifespan=lifespan)
...
def health():
    ...
    try:
        ...
        db_ok = False
    model_ok = bool(os.getenv("MODEL_PATH") or os.getenv("MODEL_URL"))
